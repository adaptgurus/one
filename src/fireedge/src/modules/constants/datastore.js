...
export const DATASTORE_OPTIONS = {
  ...
  LINSTOR: { name: 'LINSTOR / DRBD SDS', value: 'linstor' },
...
export const DS_STORAGE_BACKENDS = {
  ...
  ISCSI_MULTIPATH: {
    name: 'iSCSI SAN (Multipath + LVM)',
    value: 'layersentry-iscsi-multipath',
  },
  LINSTOR: { name: 'LINSTOR / DRBD SDS', value: 'linstor-linstor' },
...
export const DISK_TYPES_BY_STORAGE_BACKEND = {
  ...
  // OpenNebula 7.4 LVM SAN uses block devices for image and system DS.
  [DS_STORAGE_BACKENDS.FS_LVM.value]: DS_DISK_TYPES.BLOCK,
  [DS_STORAGE_BACKENDS.ISCSI_MULTIPATH.value]: DS_DISK_TYPES.BLOCK,
  [DS_STORAGE_BACKENDS.LINSTOR.value]: DS_DISK_TYPES.BLOCK,
...
export const DATASTORE_TYPES = {
  IMAGE: {
    ...
    storageBackends: [
      ...
      DS_STORAGE_BACKENDS.ISCSI_MULTIPATH,
      DS_STORAGE_BACKENDS.LINSTOR,
